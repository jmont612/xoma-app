    ...
    <View className="flex-1 bg-neutral">
      ...
      >
        <View className="px-6 pt-14">
          <Text className="text-4xl font-extrabold text-gray-900 mb-3">Habilidades</Text>
        ...
        <View className="px-6 mt-8">
          {loading && (
            <View className="items-center py-10">
              ...
              <Text className="text-primary mt-4 font-semibold">Cargando habilidades…</Text>
            </View>
          )}
          ...
          {!loading && !error && skills.map((s) => {
            ...
            return (
              ...
              >
                ...
                <Text className="text-gray-900 text-lg font-extrabold mb-2">{card.title}</Text>
                <Text className="text-gray-500 mb-6 leading-6">{card.description}</Text>
