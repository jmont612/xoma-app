      ...
      >
        <Tabs.Screen
          ...
          options={{
            title: 'Inicio',
            tabBarIcon: ({ focused }) => (
              <View className={`w-[76px] h-[52px] rounded-[24px] items-center justify-center ${focused ? 'bg-[#EAF5F5]' : 'bg-transparent'}`}>
                <Image
                  source={require('../../assets/images/home.png')}
                  contentFit="contain"
                  style={{ width: 22, height: 22, tintColor: focused ? '#2D5A6E' : '#9CA3AF' }}
                />
                <Text className={`text-[11px] mt-0.5 font-bold ${focused ? 'text-primary' : 'text-gray-400'}`}>
                  Inicio
                </Text>
              </View>
            ),
